...
struct MessageItem: Identifiable {
    ...
    static let sentPlaceholder = MessageItem(id: UUID().uuidString, isGroupChat: true,text: "ASDASDASD", type: .text, ownerUid: "1", timeStamp: Date())
    static let receivedPlaceholder = MessageItem(id: UUID().uuidString, isGroupChat: false,text: "ASDASDASD", type: .text, ownerUid: "2", timeStamp: Date())
